...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/cust/updateById" method="post">
...
<tr >
	...
	<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" ><textarea name="remark" rows=10 cols=130>${customer.remark}</textarea>
	</td>
</tr>
