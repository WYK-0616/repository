											...
											<TBODY>
												...
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写验证码 maxLength=50
														size=16 id="code" name=code> <INPUT type=hidden
														value=check name=login>
													<img id="codeimg" src="${pageContext.request.contextPath}/emp/login">
...
<script type="text/javascript">
	window.history.forward(1);
		...
		function login() {
			...
			var code = $("#code").val();
			$.ajax({
				url:"${pageContext.request.contextPath}/emp/loginValidate",
				type:"get",
