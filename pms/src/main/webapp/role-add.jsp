...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/role/save" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input name="rolename"/></td>
</tr>
<tr >
