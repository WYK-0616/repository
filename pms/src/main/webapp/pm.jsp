...
<title>用户管理</title>
    ...
    <script src="${pageContext.request.contextPath}/js/script/docs.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/layer/layer.js"></script>
    <script src="${pageContext.request.contextPath}/js/ztree/jquery.ztree.all-3.5.min.js"></script>
...
<script type="text/javascript">
       ...
       function editNode(id) {
       	   window.location.href = "${pageContext.request.contextPath}/source/getSourceById/"+id;
       }
       ...
       function deleteNode(id){
    	   layer.confirm("删除资源信息, 是否继续",  {icon: 3, title:'提示'}, function(cindex){
				...
				$.ajax({
					type : "POST",
					url  : "${pageContext.request.contextPath}/source/deleteSource/"+id,
					data : {"_method":"delete"},
